       ...
       <section className="w-screen h-screen py-8 px-4 pt-8">
            <div className="grid grid-cols-1 md:grid-cols-4 items-stretch w-full h-full gap-10">
                ...
                <div className="flex flex-col h-full md:col-span-3">
                    ...
                    {/* 1/4 tinggi: Intro */}
                    <div className="flex-1 basis-1/4 flex flex-col justify-center">
                        <h1 className="font-inika text-xl sm:text-2xl md:text-3xl font-extrabold mb-2 w-full text-center md:text-left">
                            <span className="text-black">Hi, I’m</span> <span className="text-[#A678A6]">Yesia Plorina</span>
                        </h1>
                        <p className="font-inika text-xs sm:text-sm md:text-base text-gray-700 w-full text-center md:text-left">
                            I am a Mobile developer with React Native Typescript, Kotlin for Android, and Java for Android. I am also a Fullstack JavaScript software engineer (Vue.js, React.js, Next.Js Typescript for Frontend, Node.js for Backend, and jQuery). Eager to learn and get to know more programming languages, because I think technology is the future.
                        </p>
                    </div>

                    {/* 2/4 tinggi: Experience & Education */}
                    <div className="flex-2 basis-2/4 flex items-stretch justify-center gap-8 pt-8">
                        {/* EXPERIENCE */}
                        <section className="flex-1 flex flex-col justify-start">
                            ...
                            <ul className="space-y-2">
                                ...
                                <li key={idx} className="text-sm md:text-s text-gray-700">
                    ...
                    <div className="flex-1 basis-1/4 flex flex-col justify-center">
                        ...
                        {programmingLanguages.map((lang, idx) => (
                            <span
                                key={idx}
                                className="bg-[#C8A2C8] text-white px-3 py-1 rounded-full text-xs sm:text-sm font-semibold"
                                >
                                {lang}
                            </span>
                        ))}
